...
export class ChordService {
  private chordFingeringMap: Chord = {
    ...
    'B': [{ fingering: [0, 2, 4, 4, 4, 2], barre: { fret: 2, startString: 0, endString: 5 } }, { fingering: [7, 9, 9, 8, 7, 7], barre: { fret: 7, startString: 0, endString: 5 } }],
    'C#': [{ fingering: [0, 4, 6, 6, 6, 4], barre: { fret: 4, startString: 0, endString: 5 } }],
    'Eb': [{ fingering: [0, 6, 8, 8, 8, 6], barre: { fret: 6, startString: 0, endString: 5 } }],
    ...
    'Bb': [{ fingering: [0, 1, 3, 3, 3, 1], barre: { fret: 1, startString: 0, endString: 5 } }, { fingering: [6, 8, 8, 7, 6, 6], barre: { fret: 6, startString: 0, endString: 5 } }],
    'Cm': [{ fingering: [0, 3, 5, 5, 4, 3], barre: { fret: 3, startString: 0, endString: 5 } }],
    ...
    'Bm': [{ fingering: [0, 2, 4, 4, 3, 2], barre: { fret: 2, startString: 0, endString: 5 } }],
    'C#m': [{ fingering: [0, 4, 6, 6, 5, 4], barre: { fret: 4, startString: 0, endString: 5 } }],
    'Ebm': [{ fingering: [0, 6, 8, 8, 7, 6], barre: { fret: 6, startString: 0, endString: 5 } }],
    ...
    'Bbm': [{ fingering: [0, 1, 3, 3, 2, 1], barre: { fret: 1, startString: 0, endString: 5 } }],
